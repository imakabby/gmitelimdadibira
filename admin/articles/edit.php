...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $image_description = isset($_POST['image_description']) ? clean_input($_POST['image_description']) : '';
    $youtube_video_id = isset($_POST['youtube_video_id']) ? clean_input($_POST['youtube_video_id']) : '';
    ...
    if (empty($errors)) {
        ...
        // Tambahkan kolom is_editors_pick ke query jika kolom tersedia di database
        if ($column_editors_pick_exists) {
            $sql .= ", is_editors_pick = :is_editors_pick";
        }
        ...
        // Bind parameter is_editors_pick jika kolom tersedia
        if ($column_editors_pick_exists) {
            ...
            <?php if ($success): ?>
                <div class="alert alert-success">
                    <div class="alert-content">
                        ...
                        <div class="alert-text">Artikel berhasil diperbarui!</div>
                    </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="editor-container rounded-3 overflow-hidden">
                                    <textarea id="content" name="content" class="ckeditor-editor" required><?php echo $article['content']; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <?php if ($article['image']): ?>
                                    <div class="current-image mb-3">
                                        <img src="<?php echo $article['image']; ?>" alt="Current Image" class="img-thumbnail rounded-3 border-0 shadow-sm w-100">
                                        <div class="form-text mt-2 text-muted"><small>Gambar saat ini. Upload yang baru untuk mengganti.</small></div>
                                    </div>
                                <?php endif; ?>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control bg-light border-0 shadow-sm p-3 rounded-3" 
                                       ...
                                       value="<?php echo isset($article['image_description']) ? $article['image_description'] : ''; ?>">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control bg-light border-0 shadow-sm p-3 rounded-3" 
                                       ...
                                       value="<?php echo isset($article['youtube_video_id']) ? $article['youtube_video_id'] : ''; ?>">
                                <div class="form-text mt-2 text-muted">
                            ...
                            <div class="form-group mb-4">
                                <div class="form-check">
                                    ...
                                    if ($column_editors_pick_exists) {
                                        $is_checked = isset($article['is_editors_pick']) && $article['is_editors_pick'] == 1 ? 'checked' : '';
                                    } else {
                                        $is_checked = '';
                                    }
                                    ?>
                            ...
                            <div class="form-actions pt-3">
                                <button type="submit" class="btn btn-primary w-100 mb-2" style="border-radius: 25px;">
                                    <i class="fas fa-save"></i> Perbarui Artikel
                                </button>
                                <a href="<?php echo url_base2(); ?>admin/artikel/utama" class="btn btn-outline-secondary w-100" style="border-radius: 25px;">
